						...
						<div class="domain-hero block-s3">
							...
							<form method="post" action="cart.php" id="frmDomainChecker">
								...
								<div class="input-group input-group-lg">
									...
									<input type="text" name="domain" class="form-control search-query" placeholder="{$LANG.findyourdomain}" value="{$lookupTerm}" id="inputDomain" data-toggle="tooltip" data-placement="left" data-trigger="manual" title="{lang key='orderForm.domainOrKeyword'}" />
									<span class="input-group-btn">
										<button type="submit"  id="btnCheckAvailability" class="btn btn-primary no-margin domain-check-availability{$captcha->getButtonClass($captchaForm)}" style="width: auto;">
						...
						<div class="clearfix padding-all no-padding-bottom">												
							...
							<div class=" pull-right form-inline">
								<form method="post" action="domainchecker.php" class="form-horizontal">
									{$LANG.choosecurrency}: <select class="form-control" name="currency" onchange="submit()" style="width:76px;">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="{if $domainTransferEnabled}col-md-6{else}col-md-8 col-md-offset-2{/if}">
				...
				<div class="Clean-light-box block">
